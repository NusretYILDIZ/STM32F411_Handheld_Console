...
const uint8_t test_code[] = {
	...
	get_opcode(invalid       ),
	get_opcode(draw_image    ), ADDR_IMM | TYPE_INT16   , 0xf1, 0xff, ADDR_ABS | TYPE_INT16, 255, 4, 0, 0, ADDR_IMM | TYPE_UINT16, 32, 0, ADDR_IMM | TYPE_UINT16, 32, 0, ADDR_ABS | TYPE_RAM_PTR, 0, 0x3c, 1, 0,
	get_opcode(draw_image    ), ADDR_IMM | TYPE_INT16   , 224 , 0   , ADDR_ABS | TYPE_INT16, 255, 4, 0, 0, ADDR_IMM | TYPE_UINT16, 32, 0, ADDR_IMM | TYPE_UINT16, 32, 0, ADDR_ABS | TYPE_RAM_PTR, 0, 0x3c, 1, 0,
